...
config["image_shape"] = (290, 290, 88)  # This determines what shape the images will be cropped/resampled to.
config["patch_shape"] = (64, 64, 64)  # switch to None to train on the whole image None #
...
config["data_file"] = os.path.abspath("T2_data_200_reschange.h5")
config["model_file"] = os.path.abspath("liver_segmentation_model_200.h5")
